...
g.figure.suptitle('Distribución del IMC en los 10 deportes olímpicos más practicados', fontsize=14, fontweight='bold')
...
banderas_locales = {
    'URS': 'imagenes/bandera_urss.png',
    'GDR': 'imagenes/bandera_gdr.png'
}
...
plt.xlim(-1.8, 1.7)
plt.ylim(-1.2, 1.2)
plt.title("Red de especialización deportiva con los top 10 países medalleros", fontsize=17, fontweight='bold', pad=20, color='white')
plt.axis('off')
plt.tight_layout()
